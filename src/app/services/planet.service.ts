...
import { AddPlanetList, AddPlanet, LoadPlanetList } from '../store/actions/planet.actions';
...
export class PlanetService {
  ...
  public loadPlanetList(criteria: string, url = null) {
    return this.store.dispatch(new LoadPlanetList({ criteria, url }));
  }
  public getPlanetList(): Observable<PlanetList> {
